"""Tache administratif juridique francais du banc d'essai d'atelier."""
...
@task
def admin_juridique(candidat: str | None = None, juges: str | None = None) -> Task:
    """Administratif et juridique francais : exactitude et signalement d'incertitude.
    ...
    """
    return Task(
        dataset=charge_items("admin_juridique"),
