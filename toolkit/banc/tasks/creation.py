"""Tache creation du banc d'essai d'atelier."""
...
@task
def creation(candidat: str | None = None, juges: str | None = None) -> Task:
    """Creation : refus argumente, ecart entre propositions, tenue de la voix, duree.
